...
CREATE TABLE IF NOT EXISTS `cafeteria`.`orden` (
  ...
  `Estado` TINYINT(4) NOT NULL COMMENT '0 => Desactivado\n1 => Activo',
...
CREATE TABLE IF NOT EXISTS `cafeteria`.`detalleorden` (
  ...
  `productosOrden_idProductos` INT(11) NOT NULL,
  `productosOrden_idOrden` INT(11) NOT NULL,
  PRIMARY KEY (`idDetalle`),
  INDEX `fk_detalleOrden_productosOrden1_idx` (`productosOrden_idProductos` ASC, `productosOrden_idOrden` ASC),
  CONSTRAINT `fk_detalleOrden_productosOrden1`
    FOREIGN KEY (`productosOrden_idProductos` , `productosOrden_idOrden`)
    REFERENCES `cafeteria`.`productosorden` (`idProductos` , `idOrden`)
...
CREATE TABLE IF NOT EXISTS `cafeteria`.`pago` (
  ...
  `Pagado` INT(255) NOT NULL,
  `Cambio` INT(255) NOT NULL,
  `Estado` TINYINT(4) NOT NULL,
