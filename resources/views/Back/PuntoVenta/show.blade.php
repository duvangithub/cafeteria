...
<div class="row">
 ...
 <div class="card darken-1">
  ...
  <div class="card-content">
   ...
   <a href="{{URL::action('CajaController@index')}}" class="waves-effect waves-light btn red"><i class="material-icons left">chevron_left</i>Atras</a>
  </div>
   </div>
   <!-- Extras -->
    </div>
