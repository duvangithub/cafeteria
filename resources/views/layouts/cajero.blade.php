      ...
      <ul class="side-nav fixed" id="mobile-demo">
        <li>
          <div class="user-view">
            ...
            <a href="#!name"><span class="white-text name">Cajero</span></a>
            @endif
        ...
        <li><a class="waves-effect waves-teal" href="/Back/PuntoVenta">Punto de venta<i class="material-icons left">local_dining</i></a></li>
      </ul>
    </div>
  </nav>
